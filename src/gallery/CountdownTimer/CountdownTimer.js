...
const TimeDiff = ({ diff, unit }) => (
  <div className="mx-2 md:mx-5 text-center">
    <div className="text-2xl md:text-4xl font-black">{diff}</div>
...
const CountdownTimer = () => {
  ...
  return (
    <div className="mt-40">
      <div className="text-2xl md:text-4xl font-semibold text-center">New Years Eve</div>
