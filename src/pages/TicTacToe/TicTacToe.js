  ...
  return (
    <div className="flex flex-col items-center mt-40">
      {result ? (
        ...
        <div className="text-lg">It's turn of {turn ? <strong>O</strong> : <strong>X</strong>}</div>
      )}
      ...
      <div className="grid grid-rows-3 grid-flow-col mt-5">
        {table.map((arr, row) =>
          arr.map((_, col) => (
            <div
              className="border font-bold text-3xl w-20 h-20 flex items-center justify-center"
              key={col}
