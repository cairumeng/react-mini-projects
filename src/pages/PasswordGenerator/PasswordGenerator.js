...
const PasswordGenerator = () => {
  ...
  return (
    <div className="w-1/3 mx-auto my-20 ">
      <div className="text-xl font-bold text-center mb-5">Password Generator</div>
      <div className="relative bg-gray-100">
        <div className="flex">
          <input
            type="text"
            className="focus:outline-none w-full py-2 px-4 text-gray-700 placeholder-gray-400 text-base bg-gray-100"
            name="password"
      ...
      <div className="flex divide-x mt-5">
        <div id="password-left" className="mr-3 w-1/2">
          <label className="text-gray-400 text-lg">Password length</label>
          <div className="flex">
            <input
        ...
        <div id="password-right" className="pl-5 w-1/2">
